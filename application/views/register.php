...
<div id="container">
	...
	<div id="body">
		...
		<div class="form-group row">
  			<label class="col-2 col-form-label">Công ty: </label>
  			<div class="col-10">
	    		<input class="form-control" type="text">
  			</div>
		</div>
		<div class="form-group row">
  			<label class="col-2 col-form-label">Mã số thuế: </label>
  			<div class="col-10">
	    		<input class="form-control" type="text">
  			</div>
  		</div>
		...
		<div class="form-group row">
  			<label class="col-2 col-form-label">Chức vụ: </label>
  			<div class="col-10">
	    		<input class="form-control" type="text">
  			</div>
  		</div>
		<div class="form-group row">
  			<label class="col-2 col-form-label">Điện thoại #1: </label>
  			<div class="col-10">
	    		<input class="form-control" type="text">
  			</div>
  		</div>
		<div class="form-group row">
  			<label class="col-2 col-form-label">Điện thoại #2: </label>
  			<div class="col-10">
	    		<input class="form-control" type="text">
  			</div>
  		</div>
		...
		<div class="form-group row">
  			<label class="col-2 col-form-label">Địa chỉ mail: </label>
  			<div class="col-10">
	    		<input class="form-control" type="text">
  			</div>
		</div>
		...
		<div class="form-group row">
  		...
  		<div class="form-group row">
  			<label class="col-2 col-form-label">SĐT liên hệ: </label>
  			<div class="col-10">
	    		<input class="form-control" type="text">
  			</div>
  		</div>
